...
<head>
    ...
    <title>API CNPJ - Receita Federal</title>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <label for="" id="fantasia">Nome Fantasia</label>
                <input type="text" class="form-control">
            </div>
        </div>
        ...
        <div class="form-group row">
            <div class="col-md-6">
                <label for="" id="municipio">Município</label>
                <input type="text" class="form-control">
            </div>
            <div class="col-md-6">
                <label for="" id="uf">UF</label>
                <input type="text" class="form-control">
            </div>
        </div>
    </div>
    ...
    <script>
        //script funciona apenas no console, não está retornando nos inputs
